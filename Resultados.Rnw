...
print(xtable(Heidel2, caption = "Test de medio ancho para la media calculando el intervalo de confianza al 0.95.", type = "latex"), sanitize.text.function = function(x){x})
@
