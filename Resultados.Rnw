...
Heidel1 <- data.frame(`Prueba de Estacionariedad` = rep("páso",7), check.names = F)
Heidel2 <- data.frame(NA) 
Test_HyW
@
...
xtable(tabla.incendios, caption = "Tabla de frecuencia para la base GIF Colombia.")
@
