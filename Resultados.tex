...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in .local(object, ...): the model object is not created or not valid}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in error\_measures(bridge\_H0): objeto 'bridge\_H0' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in error\_measures(bridge\_H1): objeto 'bridge\_H1' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in error\_measures(bridge\_H2): objeto 'bridge\_H2' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in error\_measures(bridge\_H3): objeto 'bridge\_H3' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H0, bridge\_H1): objeto 'bridge\_H0' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H0, bridge\_H2): objeto 'bridge\_H0' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H0, bridge\_H3): objeto 'bridge\_H0' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H1, bridge\_H2): objeto 'bridge\_H1' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H1, bridge\_H3): objeto 'bridge\_H1' no encontrado}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in bf(bridge\_H2, bridge\_H3): objeto 'bridge\_H2' no encontrado}}\end{kframe}
\end{knitrout}
